...
const recipes = [
  {
    ...
    description: "Tradicionalni recept za najukusniji džem od svežih kupina. Savršen za doručak ili kao dodatak desertima.",
    time: "45 min",
    difficulty: "Lako",
    image: "🫙",
    ingredients: [
    ...
    steps: [
      ...
      "Dodajte šećer i sok od limuna, promešajte.",
      "Ostavite da odstoji 2 sata kako bi kupine pustile sok.",
      "Stavite lonac na srednju vatru i kuvajte 30-40 minuta, povremeno mešajući.",
      "Dodajte želatin i kuvajte još 5 minuta.",
      "Vruć džem prelijte u sterilisane tegle i zatvorite.",
    ],
  },
  {
    title: "Kupinov Kolač",
    description: "Sočan kolač prepun kupina sa hrskavom koricom. Idealan za porodična okupljanja.",
    time: "1h 15min",
    difficulty: "Srednje",
    image: "🍰",
    ingredients: [
    ...
    steps: [
      ...
      "U drugoj posudi umutite puter i šećer dok ne postane penasto.",
      "Dodajte jaja jedno po jedno, pa vanilin šećer.",
      "Postepeno dodajte brašno i mešajte dok se ne sjedini.",
      "Prelijte testo u nauljen kalup, rasporedite kupine po vrhu.",
  ...
  },
  {
    ...
    description: "Osvežavajući smoothie bogat vitaminima. Savršen start dana ili užina nakon treninga.",
    time: "5 min",
    difficulty: "Lako",
    image: "🥤",
    ingredients: [
      "200 g kupina (svežih ili smrznutih)",
      "1 banana",
      "200 ml jogurta",
      "100 ml mleka",
      "1 kašika meda",
    ...
    steps: [
      ...
      "Miksajte 1-2 minuta dok ne postane glatko.",
  ...
  },
  {
    ...
    description: "Elegantni desert - sveže kupine umočene u finu tamnu čokoladu.",
    time: "20 min",
    difficulty: "Lako",
    image: "🍫",
    ingredients: [
      ...
      "50 g bele čokolade (za dekoraciju)",
      "Malo kokosovog ulja",
    ],
    steps: [
      ...
      "Otopite belu čokoladu i napravite ukrasne linije.",
      "Ohladite u frižideru 15 minuta pre serviranja.",
    ],
  },
  {
    title: "Kupinovo Vino",
    ...
    steps: [
      ...
      "Dodajte vodu, šećer i sok od limuna, dobro promešajte.",
      "Dodajte vinski kvasac prema uputstvima.",
      "Pokrijte gazom i ostavite na toplom mestu 7 dana, dnevno mešajte.",
      "Procedite tečnost i prelijte u staklenu posudu sa ventilom.",
      "Ostavite da fermentira 2-3 meseca na hladnom mestu.",
      "Pretočite u flaše i ostavite da odleži još mesec dana.",
    ],
  },
  {
    title: "Tart od Kupina",
    description: "Kremasti tart sa svežim kupinama i vanilom. Impresivan desert za posebne prilike.",
    time: "1h 30min",
    difficulty: "Srednje",
    image: "🥧",
    ingredients: [
      "Za testo: 200g brašna, 100g putera, 50g šećera, 1 jaje",
      "Za krem: 300ml slatke pavlake, 200g mascarpone sira, 3 kašike šećera u prahu",
      "400 g svežih kupina",
      "Vanilin ekstrakt",
      "Listići nane za dekoraciju",
    ],
    steps: [
      "Za testo: Pomešajte brašno, puter, šećer i jaje. Umesite i ohladite 30 min.",
      "Razvaljajte testo i stavite u kalup za tart. Pecite na 180°C 15-20 min.",
      "Ohladite pečenu koricu.",
      "Za krem: Umutite pavlaku, dodajte mascarpone, šećer i vanilu.",
      "Rasporedite krem po ohlađenoj korici.",
      "Složite kupine po vrhu u dekorativan uzorak.",
      "Ukrasite listićima nane i poslužite hladno.",
    ],
  },
];
      ...
      <section className="bg-gradient-to-br from-purple-900 via-purple-800 to-purple-900 py-20 relative overflow-hidden">
        ...
        <div className="max-w-6xl mx-auto px-6 text-center relative z-10">
          ...
          <p className="text-xl text-purple-200 max-w-2xl mx-auto">
            Otkrijte ukusne načine kako da uživate u našim kupinama kroz tradicionalne i moderne recepte
          </p>
        </div>
      </section>
